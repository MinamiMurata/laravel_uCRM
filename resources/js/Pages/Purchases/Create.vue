                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <MicroModal @update:customerId="setCustomeeId" />
                          <div v-if="errors.customer_id" class="text-red-500">{{ errors.customer_id }}</div>
                        </div>
                      </div>
                      ...
                      <div class="p-2 w-full">
                        <div>
                          ...
                          <div class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">合計: {{ totalPrice }} 円</div>
                        </div>
                      </div>
